...
},{"./modules/active-info-trainer":2,"./modules/form-validate/form":4,"./modules/play-button":10,"./modules/size-video":11,"./utils/ios-vh-fix":13}],2:[function(require,module,exports){
"use strict";
...
var trainerPhotoContainer = document.querySelectorAll('.trainer__photo-container');
var activeInfoTrainer = function activeInfoTrainer() {
  if (trainerPhotoContainer && window.innerWidth < 1200) {
    trainerPhotoContainer.forEach(function (trainerPhoto) {
      trainerPhoto.addEventListener('click', function () {
